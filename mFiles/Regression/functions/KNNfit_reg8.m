function criterion = KNNfit_reg8(X_train,y_train,X_test,y_test)
% Function: KNNfit_reg8
%
% Purpose: Fit K-nearest neighbors with k = 6 on train data. Then test on
...
Ind = knnsearch(X_train,X_test,'k',8);
